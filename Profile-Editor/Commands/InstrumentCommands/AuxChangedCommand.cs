...
{
    internal class AuxChangedCommand : ICommand
    {
        private UserSettingsStore userSettingsStore;
        private IViewModel viewModel;

        public AuxChangedCommand(UserSettingsStore userSettingsStore, IViewModel viewModel)
        {
        ...
        public void Execute(object? parameter)
        {
            ...
            instrument.Auxilliary = parameter.ToString();
        }
    }
}
